...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2024 a las 02:31:15
...
--
-- Base de datos: `tunidad_920s`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `causa_pago`
--

CREATE TABLE `causa_pago` (
  `id` int(11) NOT NULL,
  ...
  `porcentaje_mora_diario` int(11) NOT NULL,
  `id_tipo_causa_pago` int(11) NOT NULL
...
--
-- Estructura de tabla para la tabla `detalle_inmueble`
--
...
--
-- Estructura de tabla para la tabla `detalle_inmueble_pago`
--

CREATE TABLE `detalle_inmueble_pago` (
  `id` int(11) NOT NULL,
  `id_detalle_inmueble` int(11) NOT NULL,
  `id_causa_pago` int(11) NOT NULL,
  `id_persona` int(11) NOT NULL,
  `valor` double NOT NULL,
  `fecha` date NOT NULL,
  `soporte` varchar(250) NOT NULL,
  `estado` enum('registrado','acreditado','rechazado') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `detalle_inmueble_persona`
--

CREATE TABLE `detalle_inmueble_persona` (
  `id` int(11) NOT NULL,
  `id_detalle_inmueble` int(11) NOT NULL,
  `id_persona` int(11) NOT NULL,
  `tipo_relacion` enum('propietario','habitante','arrendatario','servicio') NOT NULL,
  `estado` enum('activo','inactivo') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `inmueble` (
  `id` int(11) NOT NULL COMMENT 'Este campo está indexado para mejorar la velocidad de búsqueda y optimizar las consultas que utilizan esta columna como criterio de filtrado.',
  `nomenclatura` varchar(10) NOT NULL COMMENT 'Cada valor en esta columna debe ser único y no puede repetirse en la tabla.',
  `m2` varchar(4) NOT NULL COMMENT 'Permite almacenar valores de texto para representar la superficie del inmueble. No tiene restricciones adicionales, como índices o claves únicas.',
  `id_tipo_inmueble` int(11) NOT NULL COMMENT 'El campo está indexado para mejorar la velocidad de búsqueda y optimizar las consultas que utilizan esta columna como criterio de filtrado.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `persona` (
  ...
  `género` enum('m','f','o') NOT NULL,
  `fecha_nacimiento` date NOT NULL,
  `tipo_identificación` enum('cc','pasaporte','extranjeria') NOT NULL,
  `identificación` varchar(14) NOT NULL,
...
INSERT INTO `persona` (`id`, `nombre`, `apellido`, `género`, `fecha_nacimiento`, `tipo_identificación`, `identificación`, `teléfono`, `correo`, `id_municipio`, `dirección`, `zip`) VALUES
(1, 'Gustavo', 'Rodriguez', 'm', '2000-05-12', 'cc', '1056482', '3215268452', 'gerardorodriguez.335@misena.edu.co', 679, 'casa 30 No. 3-25', '19001'),
(2, 'Gaby', 'Rodriguez', 'f', '2010-05-01', 'cc', '154872', '32545875', 'gerardorodriguez.335@misena.edu.co', 150, 'carrera 13 No. 3-55 ', '18125'),
(3, 'José', 'Peña', 'm', '2024-10-09', 'cc', '1056242', '32545879', 'jose@misena.edu.co', 107, 'calle 30 No. 3-45', '14587'),
(4, 'José', 'Rojas', 'm', '2024-06-05', 'cc', '1000582', '3145879568', 'victor@misena.edu.co', 547, 'calle 10 No. 4-11', '10256'),
(5, 'Victor', 'Perez', 'm', '2010-12-01', 'cc', '10027826', '31114898', 'andres@misena.edu.co', 547, 'carrera 3 no. 4-15', '10035'),
(14, 'Yuli', 'Espitia', 'f', '2010-05-01', 'cc', '1056458', '315458789', 'yuli@misena.edu.co', 547, 'calle 30 5_21', '19002');
...
--
-- Estructura de tabla para la tabla `tipo_causa_pago`
--

CREATE TABLE `tipo_causa_pago` (
  `id` int(11) NOT NULL,
  `titulo` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tipo_inmueble` (
  `id` int(11) NOT NULL COMMENT 'llave primaria autoincrementable para almacenar los ids de los tipos de inmuebles',
  `titulo` varchar(20) NOT NULL COMMENT 'Valor que permite almacenar el nombre o título de los tipos  deinmueble a gestionar en el proyecto'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'garodriguez335@misena.edu.co', 'popayan111', 1, 17),
(2, 'gaby@misena.du.co', 'popayan123', 2, 18);
...
--
-- Indices de la tabla `causa_pago`
--
ALTER TABLE `causa_pago`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tipo_causa_pago_causa_pago` (`id_tipo_causa_pago`);
...
--
-- Indices de la tabla `detalle_inmueble`
--
ALTER TABLE `detalle_inmueble`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_inmueble_detalle_tipo_inmueble` (`id_inmueble`);

--
-- Indices de la tabla `detalle_inmueble_pago`
--
ALTER TABLE `detalle_inmueble_pago`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_causa_pago_detalle_inmueble_pago` (`id_causa_pago`),
  ADD KEY `fk_persona` (`id_persona`),
  ADD KEY `fk_detalle_inmueble_detalle_inmueble_pago` (`id_detalle_inmueble`);

--
-- Indices de la tabla `detalle_inmueble_persona`
--
ALTER TABLE `detalle_inmueble_persona`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_detalle_inmueble_detalle_inmueble_persona` (`id_detalle_inmueble`),
  ADD KEY `fk_persona_detalle_inmueble_persona` (`id_persona`);
...
ALTER TABLE `persona`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `identificación` (`identificación`),
...
--
-- Indices de la tabla `tipo_causa_pago`
--
ALTER TABLE `tipo_causa_pago`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `causa_pago`
--
ALTER TABLE `causa_pago`
...
--
-- AUTO_INCREMENT de la tabla `detalle_inmueble`
--
ALTER TABLE `detalle_inmueble`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `detalle_inmueble_pago`
--
ALTER TABLE `detalle_inmueble_pago`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `detalle_inmueble_persona`
--
ALTER TABLE `detalle_inmueble_persona`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `inmueble`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Este campo está indexado para mejorar la velocidad de búsqueda y optimizar las consultas que utilizan esta columna como criterio de filtrado.';
...
--
-- AUTO_INCREMENT de la tabla `tipo_causa_pago`
--
ALTER TABLE `tipo_causa_pago`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tipo_inmueble`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'llave primaria autoincrementable para almacenar los ids de los tipos de inmuebles';
...
--
-- Filtros para la tabla `causa_pago`
--
ALTER TABLE `causa_pago`
  ADD CONSTRAINT `fk_tipo_causa_pago_causa_pago` FOREIGN KEY (`id_tipo_causa_pago`) REFERENCES `tipo_causa_pago` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalle_inmueble`
--
ALTER TABLE `detalle_inmueble`
  ADD CONSTRAINT `fk_inmueble_detalle_tipo_inmueble` FOREIGN KEY (`id_inmueble`) REFERENCES `inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalle_inmueble_pago`
--
ALTER TABLE `detalle_inmueble_pago`
  ADD CONSTRAINT `fk_causa_pago_detalle_inmueble_pago` FOREIGN KEY (`id_causa_pago`) REFERENCES `causa_pago` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_detalle_inmueble_detalle_inmueble_pago` FOREIGN KEY (`id_detalle_inmueble`) REFERENCES `detalle_inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_persona` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalle_inmueble_persona`
--
ALTER TABLE `detalle_inmueble_persona`
  ADD CONSTRAINT `fk_detalle_inmueble_detalle_inmueble_persona` FOREIGN KEY (`id_detalle_inmueble`) REFERENCES `detalle_inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_persona_detalle_inmueble_persona` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `inmueble`
--
ALTER TABLE `inmueble`
  ADD CONSTRAINT `fk_inmueble_tipo_inmueble` FOREIGN KEY (`id_tipo_inmueble`) REFERENCES `tipo_inmueble` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
